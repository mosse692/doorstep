  ...
  return (
    <div className="flex flex-col justify-center items-start ml-52 w-full h-full poppins">
      <div className="mt-24 mb-10 poppins-semibold">
        <p className="text-[16px] poppins text-gray-500">Home &gt; For Sale</p>
      </div>
      <div className="property_for_sale w-[73%] bg-[url('/assets/back23.jpg')] bg-center bg-no-repeat bg-cover py-3 mb-7">
        <div className="bg-white ml-5 w-[37%] rounded-lg py-[42px] pr-[22px] pl-[30px] h-auto">
          ...
          <p className="mb-4 poppins text-[#262637]">
            Search flats and houses for sale in Uganda.
          </p>
          <form action="">
      ...
      <div className="mt-7 p-[30px] w-1/2">
        <p className="text-[26px] font-bold text-gray-800 mb-[20px]">
          Simplify Buying A Home With Doorsteps
        </p>
        ...
        <ul className="flex flex-col items-start justify-between text-[20px] text-gray-800 w-[80%] list-disc ml-4">
          ...
          <li className="ml-6">
            <b className="text-gray-800">Recently sold prices: &nbsp;</b>
            <span className="text-[#606060]">
              So you can make the winning <br />
              offer
            </span>
          </li>
        </ul>
      ...
      <section className="w-full flex items-center justify-start pt-[24px] mt-6">
        <div class="max-w-[1140px] flex items-center justify-center bg-[#002A2D] pl-[3%] pt-[1.3%] rounded-[20px]">
          <section
            class=""
            data-id="6f821f2"
          ...
          >
            <div class="mb-[5%]">
              <h2 class="text-[30px] text-white font-bold">
                Sign In To Save Your Favorites
              </h2>
            </div>
            <div class="text-white poppins-semibold text-[21px] mb-[5%]">
              <p>
                Say Goodbye To Multiple Tabs. Save Your Favourite Properties For
                Sale All In One Place.
              </p>
            </div>
            {/* <div class="flex items-center justify-center  text-[18px] fill-[#002A2D] text-[#002A2D] w-[70%] h-[15%] "> */}
            <a
              class="py-[10px] px-6 text-[15px] bg-white rounded-md font-semibold ml-3"
              href="https://doorsteps.co.ug/valuate/"
            >
              Sign In or Create account
            </a>
          </section>
          <div class="" data-id="db35f86" data-element_type="column">
            <div
              data-id="b2cff5a"
      ...
      <section className="pt-[70px] pb-[30px] w-full">
        <p className="font-bold text-[27px] font-sans pb-[10px]">The latest on buying a property in Uganda</p>
        <div className="mySwiper w-[75%]">
        <Swiper
          slidesPerView={4}
          spaceBetween={20}
          freeMode={true}
